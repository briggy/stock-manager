...
@section('pt') Update Product @stop
	...
	<div class="row">
        <div class="col-lg-12">
          <div class="widget">
            ...
            {{ Form::model($p, ['class'=>'form-horizontal', 'route'=>['products.update', $p->id], 'method'=>'PUT', 'files'=>true]) }}
                <fieldset  class="col-lg-7">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls form-group">
                      {{ HTML::image($p->img(), null, ['class'=>'img-thumbnail', 'style'=>'height:150px']) }}
